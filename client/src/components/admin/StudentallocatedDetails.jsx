...
const Student = (props) => (
  <tr>
    ...
    <td>{props.student.allocatedCompany}</td>
    <td>{props.student.allocatedITAA}</td>
    <td>{props.student.selectedCompany}</td>
    <td>{props.student.interviewCount}</td>
  </tr>
);
          ...
          <table className="table">
            <thead className="thead-light">
              <tr>
                ...
                <th>Allocated ITAA</th>
                <th>Selected Company</th>
                <th>Interview faced</th>
              </tr>
            </thead>
